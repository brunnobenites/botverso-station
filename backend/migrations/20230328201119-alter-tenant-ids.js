...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.removeIndex(
      "orderTemplates",
      "orderTemplates_symbol_name_index"
    );
    ...
    await queryInterface.removeIndex(
      "withdrawTemplates",
      "withdrawTemplates_coin_name_index"
    );
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.removeIndex(
      "monitors",
      "monitors_type_symbol_interval_userId_index"
    );
    ...
    await queryInterface.removeIndex(
      "withdrawTemplates",
      "withdrawTemplates_coin_name_userId_index"
    );
